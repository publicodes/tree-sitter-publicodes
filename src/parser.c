...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [571] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_s_formule, 5, .production_id = 7),
  [573] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_s_formule, 5, .production_id = 7),
  ...
  [603] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_s_formule, 3, .production_id = 7),
  [605] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_s_formule, 3, .production_id = 7),
